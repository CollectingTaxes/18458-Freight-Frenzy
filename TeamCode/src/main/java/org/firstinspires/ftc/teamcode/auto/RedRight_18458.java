...
import org.firstinspires.ftc.teamcode.auto.RedRightCam_18458;
...
@Autonomous(name = "RedRight_18458", group = "Linear Opmode")
public class RedRight_18458 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        RedRightCam_18458 detector = new RedRightCam_18458();
        ...
        if (detector.getAnalysis() == RedRightCam_18458.ShippingPos.LEFT) {
        ...
        if (detector.getAnalysis() == RedRightCam_18458.ShippingPos.CENTER); {
            hardware.g1.setPosition(var.G1_CLOSED);
            hardware.g2.setPosition(var.G2_CLOSED);
            sleep(100);
            hardware.Arm.setPower(ARM_SPEED);
        ...
        if (detector.getAnalysis() == RedRightCam_18458.ShippingPos.RIGHT); {
            hardware.g1.setPosition(var.G1_CLOSED);
            hardware.g2.setPosition(var.G2_CLOSED);
            sleep(100);
            hardware.Arm.setPower(ARM_SPEED);
