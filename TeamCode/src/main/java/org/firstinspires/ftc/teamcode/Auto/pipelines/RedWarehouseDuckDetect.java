...
@Config
public class RedWarehouseDuckDetect extends OpenCvPipeline {

    public RedWarehouseDuckDetect() {
    }

    public static int point1x = 450;
    public static int point1y = 200;

    public static int point2x = 700;
